...
import com.konsulta.application.data.entity.SamplePerson;
import com.konsulta.application.data.service.SamplePersonService;
...
@RouteAlias(value = "haha", layout = MainLayout.class)
@Uses(Icon.class)
